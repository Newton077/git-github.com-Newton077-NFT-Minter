    ...
    icon: <CompassIcon />,
     ...
     dropdownItems: [
       ...
       { name: 'Votar',
        ...
        href: routes.vote,
        dropdownItems: [
          {name: 'Explore', href: routes.vote, },
          {name: 'Vote with criptic', href: routes.proposals, },
          {name: 'Create proposal', href: routes.createProposal, },
        ],},

  { name: 'Perfil',icon: <ProfileIcon />,href: routes.profile,},
